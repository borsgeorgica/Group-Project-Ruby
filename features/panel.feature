Feature: panel
    ...
    Then I should see "Have you hit 200 Points? Simply tweet @SpicySlice [size] [pizza type] [200] #order to get a free pizza!"
    ...
    Then I should see "info@spicyslice.com support@dspicyslice.com"
